...
VALUES(21.50, CURRENT_TIMESTAMP, NULL, 'Taxi for call-in', 3, 1, 1, 1 );
...
SELECT * FROM ERS_TYPE;
SELECT* FROM ERS_STATUS;

UPDATE ERS_REIMBURSEMENT SET REIMB_STATUSID = 3 WHERE REIMB_ID = 62;

SELECT * FROM ERS_REIMBURSEMENT WHERE REIMB_ID = 62;