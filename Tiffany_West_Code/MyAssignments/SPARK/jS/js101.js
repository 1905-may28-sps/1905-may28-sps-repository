...
/**
 * for loops: (counter declarations, counter limit; counter increment/decrement)
 */
...
/**
 * print i through n, i is divisble by 3, print 'fizz',
 * if divisible by 5, print buzz
 * if divisble by 15 print fizzbuzz
 */
console.log("**********")
 n =25;
 for(let i =1; i<25; i++){
 ...
 * functions 
 */
//variables or params are what I want to use
 ...
 function returnSomething() {
     return 'this is a js function that is returning a string value'
     
 }

 //Operators
 5 =='5'; //true because of type coersion
 5 === '5'; // false does not use type coersion, so type matters